  ...
  useEffect(() => {
    const timer = window.setTimeout(() => {
      ...
      setRecentActivity([
        ...
        {
          id: 2,
          action: "AI chatbot resolved ticket",
          user: "Sarah K.",
          time: "15 mins ago",
          type: "ai",
        },
  ...
  return (
    <div className="dashboard-home">
      <div className="dashboard-toolbar">
        ...
        <div className="dashboard-timeframe-group">
          {["today", "week", "month", "year"].map((value) => (
            <button
              key={value}
              type="button"
              className={`dashboard-timeframe-button ${timeframe === value ? "active" : ""}`}
        ...
        <div className="dashboard-toolbar-actions">
          <button type="button" className="btn-primary" onClick={onOpenChats}>
            Open Chats
          </button>
      ...
      {analyticsLoading ? (
        <div className="dashboard-analytics-loading">Loading analytics data...</div>
      ) : dashboardData ? (
        <>
          <div className="dashboard-stats-grid">
            <div className="dashboard-stat-card">
              <div className="dashboard-stat-icon">US</div>
            ...
            <div className="dashboard-stat-card">
              <div className="dashboard-stat-icon">CH</div>
              <div className="dashboard-stat-info">
            ...
            <div className="dashboard-stat-card">
              <div className="dashboard-stat-icon">MS</div>
              <div className="dashboard-stat-info">
            ...
            <div className="dashboard-stat-card">
              <div className="dashboard-stat-icon">TM</div>
              <div className="dashboard-stat-info">
            ...
            <div className="dashboard-stat-card">
              <div className="dashboard-stat-icon">CS</div>
              <div className="dashboard-stat-info">
          ...
          {dashboardData.funnel && (
            <div className="dashboard-section">
              ...
              <div className="funnel-stats">
                <span>
                  Conversion: <strong>{dashboardData.conversionRates?.visitor_to_signup || 0}%</strong>
                </span>
                <span>
                  Return Rate: <strong>{dashboardData.behavior?.returnRate || 0}%</strong>
                </span>
              </div>
            </div>
          )}
            ...
            <div className="dashboard-section">
              ...
              <div className="insights-grid">
                <div className="insight-card" style={{ borderLeftColor: "#4ade80" }}>
                  ...
                  <p className="dashboard-forecast-value">${forecastData.forecast || 0}</p>
          ...
          {behaviorData && (
            <div className="dashboard-section">
              <h2>
                <span className="section-icon">BH</span>
              ...
              <div className="insights-grid">
                <div className="insight-card">
                  <h4>Top Topics</h4>
                  {behaviorData.topTopics?.slice(0, 4).map((topic, index) => (
                    <div key={index} className="dashboard-inline-row">
                      <span>#{topic.topic}</span>
                      <span className="dashboard-inline-accent">{topic.count} chats</span>
                    </div>
                  ))}
                </div>
                ...
                <div className="insight-card">
                  <h4>Peak Hours</h4>
                  {behaviorData.peakHours?.map((hour, index) => (
                    <div key={index} className="dashboard-inline-row">
                      <span>{hour}</span>
                    </div>
                  ))}
                ...
                <div className="insight-card" style={{ borderLeftColor: "#f87171" }}>
                  ...
                  <p className="dashboard-risk-value">{behaviorData.atRisk || 0}</p>
      ...
      <div className="dashboard-stats-grid">
        ...
        <div className="dashboard-stat-card">
          <div className="dashboard-stat-icon">MR</div>
          <div className="dashboard-stat-info">
        ...
        <div className="dashboard-stat-card">
          <div className="dashboard-stat-icon">PR</div>
          <div className="dashboard-stat-info">
      ...
      <div className="dashboard-section">
        ...
        <div className="funnel-container">
          <div className="funnel-step">
            ...
            <div className="funnel-bar-wrapper">
              <div className="funnel-bar" style={{ width: "100%", background: "#4f46e5" }} />
            </div>
          </div>
          ...
          <div className="funnel-step">
            ...
            <div className="funnel-bar-wrapper">
              <div className="funnel-bar" style={{ width: "25%", background: "#7c3aed" }} />
            </div>
          </div>
          ...
          <div className="funnel-step">
            ...
            <div className="funnel-bar-wrapper">
              <div className="funnel-bar" style={{ width: "6.8%", background: "#8b5cf6" }} />
            </div>
          </div>
          ...
          <div className="funnel-step">
            ...
            <div className="funnel-bar-wrapper">
              <div className="funnel-bar" style={{ width: "1.8%", background: "#a78bfa" }} />
            </div>
          </div>
        </div>
        ...
        <div className="funnel-stats">
          <span>
            Conversion Rate: <strong>{stats.conversionRate}%</strong>
          </span>
          <span>
            Drop-off Rate: <strong>{(100 - stats.conversionRate).toFixed(1)}%</strong>
          </span>
        </div>
      </div>
      ...
      <div className="dashboard-section">
        <h2>
          <span className="section-icon">PL</span>
          Subscription Plans
        </h2>
            ...
            >
              ...
              <ul className="plan-features">
                {plan.features.map((feature, index) => (
                  <li key={index}>OK {feature}</li>
                ))}
              </ul>

              <PaymentButton amount={plan.id === "premium" ? 29 : 99} planName={plan.name} />
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="dashboard-section">
        <h2>
          <span className="section-icon">CS</span>
      ...
      <div className="dashboard-section last">
        <h2>
          <span className="section-icon">RA</span>
          Recent Activity
        </h2>
